...
int main(int argc, char *argv[]) {
	...
	for(int i=0; ;i++){
		...
		if(random_number == 0 || random_number == 6){
			...
			acao = "cria TCB e coloca em apto";
			...
			acao = "retira TCB de apto e poe em executando";
			...
			acao = "TCB sai de executando e termina";
			...
			acao = "TCB sai de executanto e vai para bloqueado";
			...
			acao = "TCB sai de executando e vai para apto";
			...
			acao = "TCB sai de bloqueado e vai para apto";
		}
